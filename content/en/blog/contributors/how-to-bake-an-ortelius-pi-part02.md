...
For DNS I use [NextDNS](https://nextdns.io/) but this is not just DNS it is complete protection for all your devices no matter where you go in the world for all your devices including your Pi MicroK8s nodes. It will use `127.0.0.1:53` to resolve your local IPs. However, you will need to do some configuration by logging into the NextDNS portal and installing the cli.
